                    ...
                    <div class="card-flyer">
                        <div class="text-box">
                            ...
                            <div class="card-footer text-center">
                                ...
                                <label for="add" name="cantidad" value="{{old('cantidad')}}"> </label>
                                <button class="btn btn-theme float-left" type="button"><</button>
                                <button class="btn btn-theme" type="button" id="add" name="add" onclick="incrementar();">+</button>
                ...
                <a href="">
                    <div class="card-flyer">
                        <div class="text-box">
                            ...
                            <div class="card-footer text-center">
                                <p>opciones</p>
                                <button class="btn btn-primary btn-sm float-left" id="left" style="color:white">
                                    Left Button
                                </button>
                                <button class="btn btn-warning btn-sm" id="center" style="color:white">
                                    Center Button
                                </button>
